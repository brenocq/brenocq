...
def generate_project_svgs():
    projects = [
        ...
        {"name": "Honeybee Democracy", "description": "A C++/ImGui simulation of honeybee swarm decision-making, where scout bees waggle-dance to advertise nest sites and a genetic algorithm evolves the best consensus strategy.", "status": get_project_status("honeybee-democracy"), "image": "https://brenocq.s3.us-east-1.amazonaws.com/readme-honeybee-democracy.png"},
        {"name": "BLDC Motor Controller", "description": "A full-stack, from-scratch BLDC motor controller — custom CAD parts, two stacked STM32F4 PCBs, firmware drivers, trapezoidal commutation, and an Atta simulation.", "status": get_project_status("bldc-motor"), "image": "https://brenocq.s3.us-east-1.amazonaws.com/readme-bldc-motor.png"},
